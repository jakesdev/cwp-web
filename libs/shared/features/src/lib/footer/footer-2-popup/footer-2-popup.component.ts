...
@Component({
  selector: 'cwp-footer-2-popup',
  templateUrl: './footer-2-popup.component.html',
  styleUrls: ['./footer-2-popup.component.scss'],
})
export class Footer2PopupComponent implements OnInit {
  listSocial = ['Facebook', 'Twitter', 'Instagram', 'Linkedin', 'Youtube', 'Pinterest', 'Github', 'Skype'];
  editHeaderForm!: FormGroup;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<Footer2PopupComponent>,
